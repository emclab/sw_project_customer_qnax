...
module SwProjectCustomerQnax
  RSpec.describe ProjectInfosController , type: :controller do
    ...
    describe "GET 'index'" do
      it "returns all info" do
        ...
        get 'index' 
        expect(assigns(:project_infos)).to match_array( [qs, qs1])       
      end
      ...
      it "should return project for the project" do
        ...
        expect(assigns(:project_infos)).to eq([qs])
      end
      ...
      it "should return for the customer" do
        ...
        get 'index' , { project_id: @proj.id }
        expect(assigns(:project_infos)).to eq([qs1])
      end
    ...
    describe "GET 'new'" do
      ...
      it "returns http success" do
        ...
        session[:user_id] = @u.id
        session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@u.id)
        get 'new' , { project_id: @proj.id, customer_id: @cust.id}
    ...
    describe "GET 'update'" do
      ...
      it "redirect if success" do
        ...
        get 'update' , {  :id => qs.id, :project_info => {:goal_to_achieve => 'newnew'}}
      ...
      it "should render 'new' if data error" do
        ...
        session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@u.id)
        qs = FactoryGirl.create(:sw_project_customer_qnax_project_info)
        get 'update' , {  :id => qs.id, :project_info => {:project_id => nil}}
